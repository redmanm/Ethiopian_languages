...
import '../quiz/english_quiz/english_quiz_page.dart';
...
class _MyCustomUIState extends State<HomeScreen3>
      ...
      child: Transform.translate(
        ...
        child: Padding(
          ...
          child: Row(
            ...
            children: [
              card(
                  title: title1, icon: icon1, route: route1, key: Key('card1')),
              card(
                  title: title2, icon: icon2, route: route2, key: Key('card2')),
            ],
          ),
        ),
      ),
...
class card extends StatelessWidget {
  ...
  const card({Key key, this.title, this.icon, this.route}) : super(key: key);
  @override
  Widget build(BuildContext context) {
    double _w = MediaQuery.of(context).size.width;
    return Container(
